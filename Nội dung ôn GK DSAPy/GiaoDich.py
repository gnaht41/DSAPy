...
class GiaoDichTienTe(GiaoDich):
    def __init__(self, salseID, orderDate, unitPrice, orderQty, typeMoney, typeTransaction):
        super().__init__(salseID, orderDate, unitPrice, orderQty)
...
def main():    
    def nhap_giao_dich():
        ...
        if loai_giao_dich.lower() == "vang":
            ...
            return GiaoDichTienTe(salseID, orderDate, unitPrice, orderQty, typeMoney, typeTransaction)
        else:
